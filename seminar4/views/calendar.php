<!--
 * calendar.php shows the calendar of one month with recipe links.
-->
...
<body>
    ...
    <ul>
        ...
        <li><a class="active" href="show_calendar.php">Calendar</a></li>
        <li class="dropdown">
    ...
    <div class="container">
        ...
        <div class = "calendar">
            ...
            <div class = "week">
                ...
                <div class = "day">
                    <a href="show_meatballs.php"><img class="img-responsive" src="resources/images/meatball-743755_640.jpg" title="Delicious Meatballs" alt="Delicious Meatballs"/></a></div>
            ...
            <div class = "week">
                ...
                <div class = "day">
                    <a href="show_pancakes.php"><img class="img-responsive" src="resources/images/pancake-square.jpg" title="Sweet pancakes" alt="Sweet pancakes"/></a></div>
            </div>
