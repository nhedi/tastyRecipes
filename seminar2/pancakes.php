...
/**
 *
 * pancakes.php is the recipe page for Pancakes.
 ...
 */
    ...
    if($_POST['comment']){
        ...
        $handle = fopen("php-login/commentsPancakes.txt", "a") or die("Unable to open comments!");
        fwrite($handle, "\n". $_POST['timestamp']. "\n". $_SESSION['user']. "\n". $content);
        fclose($handle);
    }
    ...
    if ($_POST['delete']) {
        $c = copy("php-login/commentsPancakes.txt", "php-login/copyPancakes.txt");
        ...
        file_put_contents('php-login/commentsPancakes.txt', '');
    ...
    # Recipe data
    $recipes = 'resources/xml/pancakes.xml';
...
<body>
    ...
    <div class="page">
        <div class="container">
            ...
            <img class="img-responsive" src="resources/images/pancake-1984716_640.jpg" alt="pancakes"/>
    ...
    <div class="comment">
        <div class="container">
            ...
            <div class="section group">
                ...
                <?php
				    $readComments = fopen("php-login/commentsPancakes.txt", "r") or die("Unable to open file!");
